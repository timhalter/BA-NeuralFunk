...
class DeepDrummer:
    ...
    def __init__(self, args, human_eval=False):
        ...
        self.audio_details, self.audio_pattern_bp = get_audio_param_bp()
...
# TODO 
    def generate(self):
        ...
        sd.stop()
        pattern, audio, p = sample_metro(self.model, self.fotf_checked, audio_params=self.audio_details, pattern_bp=self.audio_pattern_bp)
...
##
    def sample_good(self):
        ...
        sd.stop()
        pattern, audio, p = sample_metro(self.model, self.fotf_checked, min_p=0.95, audio_params=self.audio_details, pattern_bp=self.audio_pattern_bp)
        self.play_pattern(pattern, audio, p)
##
    def sample_bad(self):
        """
        ...
        pattern, audio, p = hillclimb(self.model, fotf=self.fotf_checked, target_score=0, target_dist=0.05, 
            audio_params=self.audio_details, pattern_bp=self.audio_pattern_bp)
        self.play_pattern(pattern, audio, p)
##
    def sample_random(self):
        ...
        sd.stop()
        pat, audio = random_pattern(fotf=self.fotf_checked, audio_params=self.audio_details, pattern_bp=self.audio_pattern_bp)
